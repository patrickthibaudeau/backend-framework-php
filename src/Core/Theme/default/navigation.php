...
// Conditionally add Admin navigation if user has management capability
if (session_status() === PHP_SESSION_NONE) { @session_start(); }
if (isset($_SESSION['userid']) && function_exists('hasCapability') && hasCapability('rbac:manage', (int)$_SESSION['userid'])) {
    $nav[] = [ 'url' => '/admin/index.php', 'label' => 'Admin' ];
    $drawer[] = [
        'url' => '/admin/index.php',
        'label' => 'Admin',
        'icon' => '<svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1l3 5 6 .9-4.5 4.4 1 6.3L12 15.9 6.5 17.6l1-6.3L3 6.9 9 6z"/></svg>'
    ];
}
